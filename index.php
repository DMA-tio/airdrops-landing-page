...
-->
                ...
                <script>
                    hbspt.forms.create({
                        ...
                        translations: {
                    <?php echo $lang; ?>: {
                        required: "<?php echo L::error_msgs_required; ?>",
                        inlineMessage: "<?php echo L::form_thankyoumsg; ?>",
                        submitText: "<?php echo L::form_register_btn; ?>",
                            fieldLabels: {
                            firstname: "<?php echo L::form_firstname; ?>",
                            lastname: "<?php echo L::form_lastname; ?>",
                            email: "<?php echo L::form_email; ?>"
                        }
                    }
                    },
                    onFormSubmit: function($form){
                        ...
                        $('input[name="language"]', $form).val('<?php echo $languageFullName[$lang]; ?>');
                    }
                    });
                </script>
    ...
    <div id="Qualify" class="column-12" >
        <div class="column-6" >
            <h1><?php echo L::section2_title1; ?></h1>
            <h3 class="subheaderTIO"><?php echo L::section2_text1; ?></h3>
            <a class="btn btn-primary btn-block btn-large" href="/downloads/PR_File.pdf" download="PR_File"><?php echo L::section2_read_more_btn;?></a>
        </div>
        <br><br><br>
        <div class="column-6" >
            <h1><?php echo L::section2_title2;?></h1>
            <!-- the container that hold the features -->


            <h3 class="subheaderTIO"><?php echo L::section2_text2;?><br><br></h3>
        </div>
    </div>

    <div id="Offer" data-aos="fade-down">
        <h1><?php echo L::section3_title1;?></h1>
        <!-- the container that hold the features -->


        <p class="Offerrings"><?php echo L::section3_text1;?><br><br></p>
        <h1><?php echo L::section3_title2;?></h1>
        <p class="Offerrings"><?php echo L::section3_text2;?></p>
    ...
    <div id="introduction">
        ...
        <h1 data-aos="fade-down"><?php echo L::section4_line1; ?></h1>
        <!-- the container that hold the features -->
        <ul class="clear-fix">
            <li class="states state_1" data-aos="fade-down">
                <h4><i class="fab fa-telegram"></i></h4>
                <h3><?php echo L::section4_point1_title; ?></h3>
                <p><?php echo L::section4_point1_text; ?><br><br></p>
            </li>
            <li class="states state_2" data-aos="fade-down" data-aos-delay="300">
                <h4><i class="fas fa-plus-circle"></i></h4>
                <h3><?php echo L::section4_point2_title; ?></h3>
                <p><?php echo L::section4_point2_text; ?><br></p>
            </li>
            <li class="states state_4" data-aos="fade-down" data-aos-delay="600">
                <h4><i class="fas fa-key"></i></h4>
                <h3><?php echo L::section4_point3_title; ?></h3>
                <p><?php echo L::section4_point3_text; ?></p>
            </li>
            <li class="states state_4" data-aos="fade-down" data-aos-delay="600">
                <h4><i class="fas fa-calendar-plus"></i></h4>
                <h3><?php echo L::section4_point4_title; ?></h3>
                <p><?php echo L::section4_point4_text; ?></p>
            </li>
    ...
    <div id="dashboard" class="" >
        ...
        <div id="dashboard_right" data-aos="fade-down" data-aos-delay="300">
            <div class="textwrap" id="DashLight" >
                <h2><span></span><?php echo L::section5_quote_title; ?></h2>
                <!--
                                  <ul class="exchange clear-fix" >
                                     <li  data-aos-delay="0"></li>
                                     <li data-aos-delay="100"></li>
                                     <li  data-aos-delay="200"></li>
                                     <li  data-aos-delay="300"></li>
                                  </ul>
                -->

                <blockquote>
                    <p><?php echo L::section5_quote_text; ?></p>
                    <cite><?php echo L::section5_quote_text_name; ?></cite>
                </blockquote>
                <br>
    ...
    <div id="footer" >
        <div id="register_footer">
            <div class="slogan" style="display: table;">
                <h2><?php echo L::section6_title1; ?></h2>
            </div>
            <h2 id="registerText" data-aos="fade-down" data-aos-delay="300"><?php echo L::section6_title2; ?></h2>
            <!--
...
-->
        ...
        <div id="risk-disclaimer" data-aos="fade-down" data-aos-delay="300">
            <strong><?php echo L::section7_risk_disclaimer_title; ?></strong><br><?php echo L::section7_risk_disclaimer_text; ?>
        </div>
        <div id="copyright">
            <div>
